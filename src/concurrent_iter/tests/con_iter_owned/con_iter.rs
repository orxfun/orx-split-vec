...
fn xyz_size_hint<G: ParGrowth>(mut vec: SplitVec<String, G>) {
    let mut n = 25;
...
#[test_matrix([SplitVec::with_doubling_growth_and_fragments_capacity(16), SplitVec::with_linear_growth_and_fragments_capacity(10, 33)])]
fn xyz_size_hint_skip_to_end<G: ParGrowth>(mut vec: SplitVec<String, G>) {
    let n = 25;
    vec = new_vec(vec, n, |x| (x + 10).to_string());
    let iter = vec.into_con_iter();
...
fn xyz_empty<G: ParGrowth>(vec: SplitVec<String, G>, nt: usize) {
    let iter = vec.into_con_iter();
...
fn xyz_next<G: ParGrowth>(mut vec: SplitVec<String, G>, n: usize, nt: usize) {
    vec = new_vec(vec, n, |x| (x + 10).to_string());
...
fn xyz_next_with_idx<G: ParGrowth>(mut vec: SplitVec<String, G>, n: usize, nt: usize) {
    vec = new_vec(vec, n, |x| (x + 10).to_string());
    let iter = vec.clone().into_con_iter();
...
fn xyz_item_puller<G: ParGrowth>(mut vec: SplitVec<String, G>, n: usize, nt: usize) {
    vec = new_vec(vec, n, |x| (x + 10).to_string());
    let iter = vec.clone().into_con_iter();
...
fn xyz_item_puller_with_idx<G: ParGrowth>(mut vec: SplitVec<String, G>, n: usize, nt: usize) {
    vec = new_vec(vec, n, |x| (x + 10).to_string());
    let iter = vec.clone().into_con_iter();
...
fn xyz_chunk_puller<G: ParGrowth>(mut vec: SplitVec<String, G>, n: usize, nt: usize) {
    vec = new_vec(vec, n, |x| (x + 10).to_string());
    let iter = vec.clone().into_con_iter();
...
fn xyz_chunk_puller_with_idx<G: ParGrowth>(mut vec: SplitVec<String, G>, n: usize, nt: usize) {
    vec = new_vec(vec, n, |x| (x + 10).to_string());
    let iter = vec.clone().into_con_iter();
...
fn xyz_flattened_chunk_puller<G: ParGrowth>(mut vec: SplitVec<String, G>, n: usize, nt: usize) {
    vec = new_vec(vec, n, |x| (x + 10).to_string());
    let iter = vec.clone().into_con_iter();
...
fn xyz_flattened_chunk_puller_with_idx<G: ParGrowth>(
    mut vec: SplitVec<String, G>,
    n: usize,
    nt: usize,
) {
...
fn xyz_skip_to_end<G: ParGrowth>(mut vec: SplitVec<String, G>, n: usize, nt: usize) {
    vec = new_vec(vec, n, |x| (x + 10).to_string());
    let iter = vec.clone().into_con_iter();
...
fn xyz_into_seq_iter<G: ParGrowth>(
    mut vec: SplitVec<String, G>,
    n: usize,
    nt: usize,
    until: usize,
