use crate::{
    common_traits::iterator::{
        flattened_iter_of_slices::FlattenedIterOfSlices, SliceBorrowAsMut, SliceBorrowAsRef,
    },
...
fn flattened_slices_iter(vec: SplitVec<usize, impl Growth>, n: usize, range: Range<usize>) {
...
fn flattened_slices_iter_mut(vec: SplitVec<usize, impl Growth>, n: usize, range: Range<usize>) {
